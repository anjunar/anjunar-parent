...
public class PageForm extends AbstractRestEntity {
    ...
    @Input(placeholder = "de.industrialsociety.anjunar.pages.page.PageForm.title.message", type = "text")
    private String title;

    @Input(placeholder = "de.industrialsociety.anjunar.pages.page.PageForm.content.message", type = "editor")
    private Editor content;

    @Input(placeholder = "de.industrialsociety.anjunar.pages.page.PageForm.language.message", type = "lazyselect")
    private Locale language;

    @Input(placeholder = "de.industrialsociety.anjunar.pages.page.PageForm.language.message", type = "lazymultiselect")
