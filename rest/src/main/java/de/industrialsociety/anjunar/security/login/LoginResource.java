...
public class LoginResource implements LinksContainer, ActionsContainer {
    ...
    @Input(placeholder = "de.industrialsociety.anjunar.security.login.LoginResource.firstName", type = "text")
    @Size(min = 3)
    private String firstName;

    @Input(placeholder = "de.industrialsociety.anjunar.security.login.LoginResource.lastName", type = "text")
    @Size(min = 3)
    private String lastName;

    @Input(placeholder = "de.industrialsociety.anjunar.security.login.LoginResource.birthdate", type = "date")
    @NotNull
    private LocalDate birthdate;

    @Input(placeholder = "de.industrialsociety.anjunar.security.login.LoginResource.password", type = "password")
    @Size(min = 3)
