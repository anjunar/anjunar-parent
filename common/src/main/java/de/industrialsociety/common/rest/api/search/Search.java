...
import de.industrialsociety.common.rest.api.search.predicate.*;
...
import de.industrialsociety.common.rest.api.search.sort.SortExpression;
...
public class Search {
    ...
    public static PredicateVisitor visitorVisit(EntityManager entityManager, CriteriaBuilder builder, AbstractQuery<?> query, Expression<?> root, Map<String, Class<?>> tables) {
        return new PredicateVisitor() {
            ...
            @Override
            public Expression<?> visitLevensthein(de.industrialsociety.common.rest.api.search.predicate.LevenstheinExpression levenstheinExpression) {
                Expression[] expressions = {
                        builder.literal(levenstheinExpression.getValue().toLowerCase()),
