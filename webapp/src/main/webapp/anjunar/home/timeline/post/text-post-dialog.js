...
export default class TextPostDialog extends HTMLWindow {
...
customViews.define({
    name: "text-post-dialog",
    header: "Post",
    resizable: false,
    class: TextPostDialog,
    guard(activeRoute) {
        if (activeRoute.queryParams.id) {
            ...
            return {
                post : jsonClient.get(`service/home/timeline/post/create?type=text`)
            }
        }
    }
})