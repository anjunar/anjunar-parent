...
export default class DomLazySelect extends HTMLElement {
    #placeholder = "";
    #open = false;
    #value;
    #items;
    ...
    render() {
        ...
        let load = () => {
            ...
            this.#items({index: this.#index, limit: this.#limit, value: input.value}, (_data, _size) => {
                this.#size = _size;
                this.#window = _data;
            });
        }
...
customComponents.define("dom-lazy-select", DomLazySelect)